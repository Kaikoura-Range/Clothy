...
// const question = await screen.findAllByText(/loading/i)
// const question = await screen.findByText(/this looks fun to wear is it fun?/i)
...
//   it('Should render RelatedCard component.', () => {


//     render(<RelatedCard data={testCardData} dispatch={()=>{}}  />);
//     const card = screen.getByTestId('RelatedCard')
//     expect(card).toBeInTheDocument();

//   })


//   it('Should Click the outfit and dispatch an action.', () => {

//     var newAction;
//     const testDispatch = (action) => { newAction = action }

//     render(<RelatedCard data={testCardData} dispatch={testDispatch}  />);
//     const outFitButton = screen.getByTestId('outfit')
//     expect(outFitButton).toBeInTheDocument();
//     fireEvent.click(outFitButton)
//     expect(newAction.type).toBe('ADD_PRODUCT_TO_OUTFIT')
//     expect(newAction.payload).toBe(testProductId)
...
// test('Should Click the navigation and dispatch an action.', () => {
...
//   render(<RelatedCard data={testCardData} dispatch={testDispatch}  />);
//   const navButton = screen.getByTestId('nav')
//   fireEvent.click(navButton)
//   console.log('numClicks', numClicks)
//   expect(numClicks).toBe(1)
//   // expect(newAction).toBe(!undefined)
// })
